...
const PROJECTS = [
  ...
  //   title: 'Travel Blog',
  //   category: 'Web App',
  //   description: 'Content-rich travel blog with immersive storytelling and map integration.',
  //   color: '#ffa726',
  //   tags: ['Next.js', 'MDX', 'Mapbox'],
  //   image: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800&h=500&fit=crop',
  // },
  // {
  //   title: 'AI Chat Interface',
  //   category: 'SaaS',
  //   description: 'Conversational AI interface with real-time streaming and context management.',
  //   color: '#7c4dff',
