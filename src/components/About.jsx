const HIGHLIGHTS = [
  ...
  { number: '8+', label: 'GitHub Repositories' },
]
          ...
          <div className="about-content slide-right">
            <div className="about-bio">
              <p className="about-intro">
                ...
                With 1+ year of experience, I focus on building digital products that are both visually compelling and performance-driven.
              </p>
              <p className="about-description">
                I build clean, modern interfaces with a strong focus on user experience.
                From design to development, I aim to create smooth and impactful digital products
