...
const SKILLS = [
  ...
  { name: 'CSS', level: 94, color: '#264de4' },
  { name: 'JavaScript', level: 90, color: '#f7df1e' },
  { name: 'React.js', level: 88, color: '#61dafb' },
  { name: 'Bootstrap', level: 87, color: '#7952b3' },
  { name: 'Tailwind CSS', level: 89, color: '#38bdf8' },
  { name: 'Figma (UI Design)', level: 85, color: '#f24e1e' },
  { name: 'WordPress (ACF)', level: 82, color: '#21759b' },
];

const TOOLS = [
  'VS Code', 'Figma', 'Git', 'GitHub', 'Vite', 'NPM', 'Vercel',
]
